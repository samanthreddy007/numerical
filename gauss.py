...
def gauss(A, b, x_prev, tol, maxiter):
    ...
    # print(f"R {R}")
    T = np.matmul(np.linalg.inv(D-L), R )
...
# x,iteration,total_time, all_x,eig = gauss(A,b,None,10 ** (-15), 250)
# print(all_x)
# plot_x(all_x)
...
if __name__ == "__main__":
    ...
    print(A)
    print(b)
    x, iteration, total_time, all_x,spectral_radius = gauss(A,b,None,0.1, 250)
